<script setup>
  ...
  supabase.auth.onAuthStateChange((event, session) => { 
    if(session==null){ 
      ...
      document.getElementById('status').innerHTML='You are logged with github: ' + session.user.email; 
    } 
  })
  </script>
  ...
  <script>
  const SUPABASE_URL = 'https://rriaygmuzhuzmqnmkcph.supabase.co'
  const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJyaWF5Z211emh1em1xbm1rY3BoIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjMzMzYyOTcsImV4cCI6MTk3ODkxMjI5N30.cHSvG9KJWuQAjXWnzfi6s1i_XkSHslyoKZ60sm9atm8'
